...
Initial public release. OAT orchestrates teams of coding agents on real GitHub
repos: a supervisor plans, workers execute on isolated worktrees, verifiers
gate output, and a merge queue lands PRs once CI passes.
