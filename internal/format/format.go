...
const (
	...
	StatusWaitingForPR           Status = "waiting for PR"
	StatusWaitingForVerification Status = "waiting for verification"
)
...
func StatusColor(status Status) *color.Color {
	...
	case StatusHealthy, StatusRunning, StatusCompleted:
		return Green
	case StatusWarning, StatusIdle, StatusPending, StatusWaitingForPR, StatusWaitingForVerification:
		return Yellow
	case StatusError:
		return Red
	default:
...
func StatusIcon(status Status) string {
	...
	case StatusError:
		return "✗"
	case StatusPending, StatusWaitingForPR, StatusWaitingForVerification:
		return "◦"
	default:
		return "-"
	}
