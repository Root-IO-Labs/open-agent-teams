...
func StateDocs() []StateFieldDoc {
	return []StateFieldDoc{
		...
		{Field: "repos.<name>.session_name", Type: "string", Description: "Name of the backend session for this repo"},
		...
		{Field: "repos.<name>.agents.<name>.window_name", Type: "string", Description: "Window name for this agent"},
		{Field: "repos.<name>.agents.<name>.session_id", Type: "string", Description: "UUID for agent session context"},
		{Field: "repos.<name>.agents.<name>.pid", Type: "int", Description: "Process ID of the agent process"},
		...
		{Field: "repos.<name>.agents.<name>.ready_for_cleanup_at", Type: "time.Time", Description: "When agent was marked ready for cleanup (for delayed cleanup, omitempty)"},
		{Field: "repos.<name>.agents.<name>.issue_number", Type: "string", Description: "GitHub issue number for this task (workers only, omitempty)"},
		{Field: "repos.<name>.agents.<name>.issue_url", Type: "string", Description: "Optional issue URL (workers only, omitempty)"},
	}
}
