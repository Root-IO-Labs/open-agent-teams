...
```json
{
  ...
  "resolved_model": "",               // Spawn-time resolved model — the literal `-M` value handed to the agent runtime, frozen at spawn so later daemon-default changes can't lie about what's actually running
