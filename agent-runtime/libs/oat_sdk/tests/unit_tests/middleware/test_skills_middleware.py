...
def test_create_oat_agent_with_skills_and_filesystem_backend(tmp_path: Path) -> None:
    """Test end-to-end: create_oat_agent with skills parameter and FilesystemBackend."""
...
def test_create_oat_agent_with_skills_empty_directory(tmp_path: Path) -> None:
...
def test_create_oat_agent_with_skills_default_backend() -> None:
    """Test create_oat_agent with skills parameter using default backend (no backend specified).
