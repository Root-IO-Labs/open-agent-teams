...
from oat_sdk.backends.protocol import BackendProtocol, EditResult, FileDownloadResponse, WriteResult
...
def mock_get_config(thread_id: str | None = "test-thread-123") -> Generator[None, None, None]:
    ...
    with patch("oat_sdk.middleware.summarization.get_config", return_value=config):
        yield
