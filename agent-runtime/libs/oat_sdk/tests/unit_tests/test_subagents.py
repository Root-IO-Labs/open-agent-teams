...
class TestSubAgents:
    ...
    def test_custom_subagent_does_not_inherit_skills(self, tmp_path: Path) -> None:
        """Test that custom subagents do NOT inherit skills middleware from create_oat_agent.

        This test verifies that:
        1. When create_oat_agent is called with skills, only the general-purpose subagent gets SkillsMiddleware
    ...
    def test_general_purpose_subagent_inherits_skills_from_main_agent(self, tmp_path: Path) -> None:
        ...
        This test verifies that:
        1. When create_oat_agent is called with skills, the general-purpose subagent gets SkillsMiddleware
