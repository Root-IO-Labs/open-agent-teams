...
Related issue: https://github.com/Root-IO-Labs/open-agent-teams/pull/872
...
from oat_sdk.backends.sandbox import (
...
def test_sandbox_read_uses_payload() -> None:
    ...
    assert "__OAT_EOF__" in sandbox.last_command
