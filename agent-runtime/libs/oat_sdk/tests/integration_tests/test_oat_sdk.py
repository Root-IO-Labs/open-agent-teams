...
class TestOatSdk:
    def test_deep_agent_with_subagents(self):
        ...
        agent = create_oat_agent(tools=[sample_tool], subagents=subagents)
    ...
    def test_deep_agent_with_extended_state_and_subagents(self):
        ...
        agent = create_oat_agent(tools=[sample_tool], subagents=subagents, middleware=[ResearchMiddleware()])
        assert_all_oat_sdk_qualities(agent)
    ...
    def test_response_format_tool_strategy(self):
        ...
        agent = create_oat_agent(response_format=ToolStrategy(schema=StructuredOutput))
