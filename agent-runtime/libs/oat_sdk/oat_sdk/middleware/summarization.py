...
agent = create_oat_agent(middleware=[summ, tool_mw])
```
...
from oat_sdk.middleware._utils import append_to_system_message
...
if TYPE_CHECKING:
    ...
    from oat_sdk.backends.protocol import BACKEND_TYPES, BackendProtocol
...
class _OatSdksSummarizationMiddleware(AgentMiddleware):
        ...
        **deprecated_kwargs: Any,
        ...
        Args:
            ...
            truncate_args_settings: Settings for truncating large tool arguments in old messages.
                ...
                Provide a [`TruncateArgsSettings`][oat_sdk.middleware.summarization.TruncateArgsSettings]
...
# Public alias
SummarizationMiddleware = _OatSdksSummarizationMiddleware


def create_summarization_middleware(
    model: BaseChatModel,
    backend: BACKEND_TYPES,
) -> _OatSdksSummarizationMiddleware:
...
class SummarizationToolMiddleware(AgentMiddleware):
    ...
    an explicit user action, e.g. as implemented in the oat_sdk-cli).
    ...
    def __init__(self, summarization: _OatSdksSummarizationMiddleware) -> None:
