...
DEFAULT_CONFIG_DIR = Path.home() / ".oat"
"""Directory for user-level OAT configuration (`~/.oat`)."""

DEFAULT_CONFIG_PATH = DEFAULT_CONFIG_DIR / "config.toml"
"""Path to the user's model configuration file (`~/.oat/config.toml`)."""
...
class ModelConfig:
    ...
    def load(cls, config_path: Path | None = None) -> ModelConfig:
        ...
        Args:
            config_path: Path to config file. Defaults to ~/.oat/config.toml.
