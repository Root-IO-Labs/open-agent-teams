...
from oat_sdk import create_oat_agent
from oat_sdk.backends import CompositeBackend, LocalShellBackend
from oat_sdk.backends.filesystem import FilesystemBackend
from oat_sdk.middleware import MemoryMiddleware, SkillsMiddleware
...
if TYPE_CHECKING:
    ...
    from oat_sdk.middleware.subagents import CompiledSubAgent, SubAgent
...
from oat_cli.integrations.sandbox_factory import get_default_working_dir
from oat_cli.local_context import LocalContextMiddleware, _ExecutableBackend
from oat_cli.subagents import list_subagents
...
def list_agents() -> None:
    ...
    agents_dir = settings.user_oat_dir / "agents"

    if not agents_dir.exists() or not any(agents_dir.iterdir()):
        console.print("[yellow]No agents found.[/yellow]")
        console.print(
            "[dim]Agents will be created in ~/.oat/agents/ "
...
def get_system_prompt(assistant_id: str, sandbox_type: str | None = None) -> str:
    ...
    skills_path = f"~/.oat/agents/{assistant_id}/skills/"
...
def create_cli_agent(
    ...
    *,
    ...
    This is the main entry point for creating a oat_sdk CLI agent, usable
    ...
    if enable_skills:
        ...
        # built-in -> user .oat -> user .agents
        # -> project .oat -> project .agents
    ...
    if sandbox is None:
        ...
        large_results_backend = FilesystemBackend(
            root_dir=tempfile.mkdtemp(prefix="oat_sdk_large_results_"),
            virtual_mode=True,
        )
        conversation_history_backend = FilesystemBackend(
            root_dir=tempfile.mkdtemp(prefix="oat_sdk_conversation_history_"),
            virtual_mode=True,
        )
    ...
    from oat_sdk.graph import resolve_model
