...
from oat_sdk.backends.sandbox import BaseSandbox

from oat_cli.integrations.sandbox_provider import (
    SandboxProvider,
)
...
class ModalProvider(SandboxProvider):
    ...
    def __init__(self, app_name: str = "oat_sdk-sandbox") -> None:
        """Initialize Modal provider.

        Args:
            app_name: Name for the Modal app (default: "oat_sdk-sandbox")
        """
        import modal
