...
- oat_sdk skills list [options]
- oat_sdk skills create <name> [options]
- oat_sdk skills info <name> [options]
- oat_sdk skills delete <name> [options]
"""
...
if TYPE_CHECKING:
    ...
    from oat_sdk.middleware.skills import SkillMetadata

from oat_cli.config import COLORS, Settings, console, get_glyphs
...
def _list(agent: str, *, project: bool = False) -> None:
    ...
    if project:
        ...
        has_oat_sdk_skills = project_skills_dir.exists() and any(
        ...
        if not has_oat_sdk_skills and not has_agent_skills:
            ...
            console.print(
                ...
                "  oat_sdk skills create my-skill --project[/dim]",
                style=COLORS["dim"],
            )
            return
        ...
        if not skills:
            ...
            console.print(
                ...
                "  oat_sdk skills create my-skill[/dim]",
                style=COLORS["dim"],
            )
            return
...
# license: Apache-2.0
# compatibility: Designed for OAT CLI
# metadata:
#   author: your-org
#   version: "1.0"
...
def _create(skill_name: str, agent: str, project: bool = False) -> None:
    ...
    console.print(
        ...
        f"  nano {skill_md}\n"
        "\n"
        "  See examples/skills/ in the oat-cli repo for example skills:\n"
        "   - web-research: Structured research workflow\n"
        "   - langgraph-docs: LangGraph documentation lookup\n"
        "\n"
        "   Copy an example:\n"
        "   cp -r examples/skills/web-research ~/.oat/agents/agent/skills/\n",
        style=COLORS["dim"],
    )
...
def setup_skills_parser(
    ...
    *,
    ...
    `oat_sdk skills -h` shows skills-specific help, not the
    global help.
    ...
    create_parser = skills_subparsers.add_parser(
        ...
        description=(
            ...
            "~/.oat/agents/<agent>/skills/. "
            "Use --project to create in the project's "
            ".oat/skills/ directory."
        ),
        add_help=False,
