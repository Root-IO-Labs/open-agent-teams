...
oat_sdk.middleware.skills and adapts it for direct filesystem access
needed by CLI commands.

For middleware usage within agents, use
oat_sdk.middleware.skills.SkillsMiddleware directly.
"""
...
from oat_sdk.middleware.skills import (
    SkillMetadata,
...
def list_skills(
    *,
    ...
    1. `user_skills_dir` (`~/.oat/agents/{agent}/skills/`)
    2. `user_agent_skills_dir` (`~/.agents/skills/`)
    3. `project_skills_dir` (`.oat/skills/`)
    ...
    Args:
        ...
        user_skills_dir: Path to `~/.oat/agents/{agent}/skills/`.
        project_skills_dir: Path to `.oat/skills/`.
    ...
    # 1. User OAT skills (~/.oat/agents/{agent}/skills/)
    ...
    # 2. User agent skills (~/.agents/skills/) - overrides user oat_sdk
    ...
    # 3. Project OAT skills (.oat/skills/)
