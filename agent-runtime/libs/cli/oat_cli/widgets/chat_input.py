"""Chat input widget for oat-cli with autocomplete and history support."""
...
if TYPE_CHECKING:
    ...
    from oat_cli.input import ImageTracker, ParsedPastedPathPayload
...
class ChatTextArea(TextArea):
    ...
    def _flush_paste_burst(self) -> None:
        ...
        from oat_cli.input import parse_pasted_path_payload
...
class ChatInput(Vertical):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            history_file: Path to history file (default: ~/.oat/history.jsonl)
    ...
    def _extract_leading_dropped_path_with_command_recovery(
        ...
        """
        from oat_cli.input import extract_leading_pasted_file_path
    ...
    def _build_path_replacement(
        ...
        *,
        ...
        from oat_cli.image_utils import get_image_from_path
